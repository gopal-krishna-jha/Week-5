...
class ReadFile{
    //Create a static method to read file and count no of row the data
    public static int readFileAndCountRows(String filePath){
        //Create a variable to count the number of rows
        int noOfRows = 0;
...
//Create a class ReadAndCountRowsInCSVFile
public class ReadAndCountRowsInCSVFile {
    public static void main(String[] args) {
        ...
        //Create a variable to store the noOfRows and Call the method
        int noOfRows = ReadFile.readFileAndCountRows(filePath);
